...
plt.plot(df_yolov5['               epoch'], df_yolov5['metrics/mAP_0.5:0.95'], label='YOLOv5 mAP@0.5:0.95', color='blue', marker='o')
plt.plot(df_yolov10['                  epoch'], df_yolov10['    metrics/mAP50-95(B)'], label='YOLOv10 mAP@0.5:0.95', color='green', marker='x')

plt.xlabel('Epoch')
plt.ylabel('mAP@0.5:0.95')
plt.title('mAP@0.5:0.95 Comparison: YOLOv5 vs. YOLOv10')
